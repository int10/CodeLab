...
HEADERS += \
    ...
    FilterLineEdit.h \
    RemoteDatabase.h \
    sqlcipher/sqlcipher/crypto.h \
    sqlcipher/sqlite/sqlite3.h \
    sqlcipher/sqlite/sqlite3ext.h
...
SOURCES += \
    ...
    FilterLineEdit.cpp \
    RemoteDatabase.cpp \
    sqlcipher/sqlcipher/crypto.c \
    sqlcipher/sqlcipher/crypto_impl.c \
    sqlcipher/sqlcipher/pager.c \
    sqlcipher/sqlite/sqlite3.c
...
#    DEPENDPATH += $$PWD/../../../dev/SQLite
    INCLUDEPATH += ./sqlcipher ./sqlcipher/sqlite
    INCLUDEPATH += $$PWD/inc
    DEPENDPATH += $$PWD/inc
